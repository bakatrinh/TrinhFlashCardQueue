...
/**
 * @author Trinh Nguyen
 * <br>Description: Custom JPanel to be used as Color buttons by {@link ViewEditCardJDialog}
 */
public class ViewEditCardColorButton extends JPanel {
	 ...
	 * {@link ModelFlashCard}.
	 * <br>Complexity: O(1).
	 * @param mainController A reference to the {@link ControllerMain} so that it can run a method
